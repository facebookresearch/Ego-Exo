...
from slowfast.models.losses import loss_fn_kd
...
def train_epoch(
    ...
    for cur_iter, (inputs, labels, _, meta) in enumerate(train_loader):
        ...
        # print(meta["teacher_label"].shape, preds1.shape)

        #loss = (1 - cfg.KD.ALPHA) * loss + kd_loss
        ...
        if cfg.DETECTION.ENABLE:
            ...
            train_meter.update_stats(
                top1_err, top5_err, loss, lr, inputs[0].size(0) * cfg.NUM_GPUS, stats=extra_loss,
            )
            # write to tensorboard format if available.
            if writer is not None:
                writer.add_scalars(
