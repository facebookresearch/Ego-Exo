...
@MODEL_REGISTRY.register()
class HandObjKdSlowFast(SlowFast):
    def _construct_network(self, cfg):
        super()._construct_network(cfg)
...
@MODEL_REGISTRY.register()
class HandObjKdSlowFastHSlow(HandObjKdSlowFast):
    def _construct_network(self, cfg):
        super()._construct_network(cfg)
