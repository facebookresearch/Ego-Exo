...
from .kinetics_aux import _load, parse_handobj, spatial_sampling_with_boxes

logger = logging.get_logger(__name__)


@DATASET_REGISTRY.register()
class Epickitchenhandobj(Epickitchen):
    '''
    Support single label for epic-55 and epic-100
    with loading hand-obj boxes
    '''   
    def __getitem__(self, index):
        ...
        # hand, objects
        frame_index = [x + start_frame for x in seq]
        videoname = self._videos[index]['video_id']
